...
config :invader, InvaderWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: InvaderWeb.ErrorHTML, json: InvaderWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Invader.PubSub,
  live_view: [signing_salt: "uJgJruV1"]
...
config :invader, Invader.Mailer, adapter: Swoosh.Adapters.Local
